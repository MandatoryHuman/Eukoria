...
In order to use an anchor, it must first be attuned to - a process that is done during daily preparations. This process is similar to Investing in an item, though it does not take up any of a character's invested item capacity. A character can only be attuned to a single Anchor at a time, and attuning to a second causes attunement to the first to be lost. Once attuned, a character can use the item's abilities.
