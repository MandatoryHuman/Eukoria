...
# Opiroth Dependency - Disease 8

Because Opiroth Resin fundamentally alters how a body processes cosmic friction, withdrawal symptoms manifest not just as physical tremors, but as minor, painful reality-warping afflictions - such as phantom pains from injuries that never occurred, or memories of events that haven't happened.

**Saving Throw** DC 24 Fortitude; **Onset** 1 day; **Maximum Duration** permanent.

- **Stage 1:** You become Fatigued. This condition cannot be reduced by resting until the dependency is cured or another dose of Opiroth Resin is consumed. (1 week)
